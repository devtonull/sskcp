...
install_kcptun() {
    ...
    cd /usr/local/kcptun
    wget https://github.com/xtaci/kcptun/releases/download/v20240906/kcptun-linux-amd64-20240906.tar.gz
    tar -zxvf kcptun-linux-amd64-20240906.tar.gz
...
#update-rc.d /etc/init.d/autokcp defaults
#update-rc.d -f /etc/init.d/autokcp remove
sleep 60
